...
$the_core_less_variables['fw-mobile-menu-overlay-color']    = 'transparent';
$the_core_less_variables['fw-mobile-menu-overlay-opacity']  = 1;
...
$the_core_less_variables['fw-sticky-menu-bg-opacity']       = 100;
