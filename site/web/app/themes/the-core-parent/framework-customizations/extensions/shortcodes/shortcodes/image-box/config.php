...
$cfg = array(
	'page_builder' => array(
		'title'       => __( 'Image Box', 'the-core' ),
		'description' => __( 'Add an Image Box', 'the-core' ),
		'tab'         => __( 'Content Elements', 'the-core' ),
		'popup_size'  => 'medium',
		'title_template' => '{{ if (!o["box-title"]) { }} {{- title}} {{ } }} {{ if (o["box-title"]) { }} {{- o["box-title"].trim().replace(/(<([^>]+)>)/ig,"").replace(/&nbsp;/gi, "")}} {{ } }}',
