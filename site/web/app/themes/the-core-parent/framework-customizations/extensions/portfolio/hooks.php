...
if ( ! function_exists( 'the_core_filter_fw_portfolio_templates' ) ) :
	function the_core_filter_fw_portfolio_templates( $templates ) {
		if ( ! defined( 'FW' ) || ! class_exists( 'FW_Extension_Portfolio' ) ) {
			return;
		}

		return array_merge( $templates,
			array( 'portfolio-visual-builder.php' => __( 'Visual Builder Template', 'the-core' ) )
		);
	}
endif;
add_filter( 'theme_fw-portfolio_templates', 'the_core_filter_fw_portfolio_templates' );
