...
if ( class_exists( 'LearnPress' ) ) {
	$the_core_content_single_course = 'content-single-learnpress';
}
else {
	$the_core_content_single_course = 'content-single-sensei';
}
?>
			...
			<div class="fw-content-area <?php the_core_get_content_class( 'content', $the_core_sidebar_position ); ?>">
				<div class="fw-col-inner">
					...
					<?php while ( have_posts() ) : the_post();
						get_template_part( $the_core_content_single_course );
